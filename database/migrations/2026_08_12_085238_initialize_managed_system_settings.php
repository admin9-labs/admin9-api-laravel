...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        $connection->transaction(function () use ($connection): void {
            ...
            $connection->table('system_configs')->insertOrIgnore($rows);
    ...
    /**
     * The initialized values may have been edited after deployment, so rollback
     * intentionally preserves them and does not recreate obsolete test data.
     */
